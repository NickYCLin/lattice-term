...
本專案使用台灣日期作為版號（年．月．日，例如 `2026.9.18`），每天有新功能或修補且通過驗證才發布。所有更新內容均以繁體中文條列說明，詳細規則見 [Release 自動化與版本規則](docs/RELEASE_AUTOMATION.zh-TW.md)。
...
* **desktop:** 擴充九語介面與檔案拖放並修正回歸問題 ([#232](https://github.com/NickYCLin/lattice-term/issues/232)) ([a03bb5d](https://github.com/NickYCLin/lattice-term/commit/a03bb5d772ccc49a944d123c6699f9606c2f6ca1))
* **fleet:** 加入 CLIProxyAPI 模型啟動選項 ([f79f89b](https://github.com/NickYCLin/lattice-term/commit/f79f89b94712074adc7a50a875d7cf79cf1ba770))
...
* **agent:** 修正 Codex 背景工作燈號誤判 ([bd9a08c](https://github.com/NickYCLin/lattice-term/commit/bd9a08c33e592d8a2838a57c5008421becd42860))
* **agent:** 讓 Codex 使用已授權的遠端連線 ([021a77b](https://github.com/NickYCLin/lattice-term/commit/021a77b0159af2f62e04bbbcdd81e8e165ce3961))
* **ci:** 補齊 Antigravity 與 CLIProxyAPI 之後過期的測試 ([#237](https://github.com/NickYCLin/lattice-term/issues/237)) ([9173eaf](https://github.com/NickYCLin/lattice-term/commit/9173eafb880a948de3c842f1ad10552deb035981))
