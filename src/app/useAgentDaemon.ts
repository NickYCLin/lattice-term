...
export interface AgentMcpHistory {
  entries: {
    ...
    at: number;
    client: string;
    action: "launch" | "prompt" | "queue" | "clearQueue" | "stop" | "remoteMetrics" | "remoteList" | "remoteExec" | "remoteUpload" | "remoteDownload" | "remoteCancel" | "remoteStatus" | "remoteScreen" | "remoteInput" | "grant" | "revoke" | "read" | "interrupt";
