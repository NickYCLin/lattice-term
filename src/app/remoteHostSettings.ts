...
export function loadRemoteHostSettings(storage: Storage): RemoteHostStartRequest {
  ...
  const defaults: RemoteHostStartRequest = { bindAddress: "", port: 44900, fps: 5, allowInput: false, allowFiles: false, allowCommands: false, allowChat: false, allowCli: false, fileRoot: "", mode: relay ? "relay" : "direct", relayAddress: relay, pairingCode: "" };
  try {
