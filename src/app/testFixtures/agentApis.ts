...
export function fakeAgentApi(overrides: Partial<AgentApi> = {}): AgentApi {
  return {
    ...
    setQueueDependency: vi.fn(async () => {}),
    maxActiveSessions: null,
    setMaxActiveSessions: vi.fn(async () => {}),
    resize: vi.fn(async () => {}),
...
export function fakeChatApi(overrides: Partial<AgentChatApi> = {}): AgentChatApi {
  return {
    ...
    importNativeConversation: vi.fn(() => fakeThread()),
    importArchivedConversation: vi.fn(() => fakeThread({ archived: true })),
