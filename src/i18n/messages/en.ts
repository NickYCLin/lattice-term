...
export const en: Messages = {
  ...
  "settings.mcpRemote.hint": "Allow external AI tools to use SSH, SFTP, RDP, VNC or Lattice Remote connections you explicitly authorize here.",
  ...
  "settings.mcpRemote.boundary": "Off by default and valid only for this desktop connection. You can open a saved connection through secure storage, but operations still need a separate scope grant; SSH host keys are never accepted automatically. Closing the desktop or losing its daemon connection revokes access. Revocation does not undo completed commands or file writes.",
