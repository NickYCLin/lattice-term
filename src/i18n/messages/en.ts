...
export const en: Messages = {
  ...
  "workspace.projects.saved": "Saved local projects",
  "workspace.projects.remove": "Remove project entry",
  "workspace.projects.closeFirst": "Close the project's CLI tabs first",
  "workspace.projects.confirm": "Remove this project entry and its pending restores? Files on disk will remain.",
  "workspace.recovery.load": "Load recovery copies",
  "workspace.recovery.copy": "Copy {number}",
  "workspace.recovery.unreadable": "This copy cannot be imported by this version; the original data is retained.",
  "workspace.recovery.preview": "Recovery preview",
  "workspace.recovery.importHint": "Import adds missing local sessions to the retry list. It does not replace current sessions or launch commands.",
  "workspace.recovery.import": "Import into retry list",
  "workspace.recovery.imported": "Added to retry list",
  "jev.title": "Session attention advisor · Jev",
  "jev.hint": "Choose a CLI and review an excerpt before sending it to TypeSafe AI for classification. Off by default; no background scanning or session control.",
  "jev.setup": "How to sign up and get started",
  "jev.setup.login": "Open the official TypeSafe console and sign in with Google or email. If signups are full or paused, leave this feature off until access reopens. Existing accounts follow their console access status.",
  "jev.setup.key": "Once access is granted, create an API key in the console and check your balance and billing terms. Do not paste the key into chats or project files.",
  "jev.setup.enable": "Enter your key below to enable this session. Review and edit each excerpt before analysis. Disabling the feature or exiting LatticeTerm clears the key.",
  "jev.console": "Open the official TypeSafe console",
  "jev.key": "TypeSafe API key (this app session only)",
  "jev.enable": "Enable for this session",
  "jev.enabled": "Enabled; API calls occur only when you submit an excerpt",
  "jev.disable": "Disable and clear key",
  "jev.session": "Session to inspect",
  "jev.choose": "Choose a session",
  "jev.preview": "Read local excerpt",
  "jev.reviewHint": "Up to 40 recent lines and 8 KB, with best-effort masking of common keys, URLs, emails and paths. Review and remove sensitive content yourself. Terminal redraws and truncation can affect interpretation.",
  "jev.excerpt": "Excerpt to send (editable)",
  "jev.consent": "I reviewed this excerpt and agree to send the content above to the TypeSafe API using my API allowance.",
  "jev.busy": "Working…",
  "jev.analyze": "Send this excerpt for analysis",
  "jev.resultHint": "AI interpretation of this excerpt only. It may be wrong or stale. Check the original session; this does not establish CLI state or acceptance.",
  "jev.tokens": "{count} input tokens",
  "jev.category.waiting_input": "May be waiting for your response",
  "jev.category.login_required": "May need login or credential repair",
  "jev.category.quota_limited": "May be blocked by usage or rate limits",
  "jev.category.update_required": "May need an update or restart",
  "jev.category.execution_error": "May have an unresolved execution error",
  "jev.category.no_action": "No explicit intervention request in the excerpt",
  "jev.category.unknown": "Insufficient evidence",
  "jev.error.internal": "Could not complete this action. Reopen this page and try again.",
  "jev.error.key": "Invalid key format. Check for whitespace or line breaks.",
  "jev.error.consent": "Review the excerpt and agree to send it first.",
  "jev.error.busy": "Another analysis is in progress.",
  "jev.error.disabled": "The feature was disabled or reconfigured. Analysis cancelled.",
  "jev.error.input": "Provide nonempty plain text, at most 40 lines and 8 KB.",
  "jev.error.network": "Connection failed or the service did not respond normally. Retry manually later.",
  "jev.error.auth": "TypeSafe denied access. Check your API key and account access.",
  "jev.error.billing": "TypeSafe reported a billing limit. Check the official console.",
  "jev.error.rate": "TypeSafe is busy or rate limited. Retry manually later.",
  "jev.error.response": "Unexpected response format or model version. This result was not used.",
  "jev.error.session": "Output is no longer available. Choose another session.",
  "cliUpdates.title": "External CLI updates",
  "cliUpdates.hint": "You can update detected CLIs directly, or open the official guide to update manually. Restart existing CLI sessions to use the new version.",
  ...
  "cliUpdates.instructions": "Open official update guide ↗",
  "cliUpdates.checking": "Checking…",
  "cliUpdates.recheck": "Check versions again",
  ...
  "sessionChat.unsupported": "Conversation history is not supported for this assistant yet. You can send messages and view replies in Terminal.",
  "sessionChat.readError": "This session's conversation could not be read yet. Retrying shortly; you can view it in Terminal.",
  "sessionChat.waiting": "Waiting for this session to write its conversation…",
  ...
  "sessionChat.approval": "Open Terminal to handle permission requests or other CLI interactions.",
  "sessionChat.send": "Send",
  "sessionChat.sending": "Sending…",
  "history.autoOpen": "Open all local conversations automatically at startup",
  "history.autoOpenHint": "Connects now and adds missing conversations on future starts. Each conversation and account shares one session between Terminal and Chat. Sessions over the running limit or unable to start remain in Saved projects and recovery.",
  "history.autoOpening": "Saving and opening local conversations…",
  ...
  "sidebar.storage.unreadableTitle": "Folder layout can't be read",
  "sidebar.storage.unreadableBody": "The saved sidebar folders are damaged or were written by a newer LatticeTerm. You can still arrange folders here, but changes are not saved.",
  "sidebar.storage.reset": "Back up and save again",
  "sidebar.storage.resetTitle": "Save sidebar folders again",
  "sidebar.storage.resetBody": "The unreadable copy is kept aside first, then the folders you see now become the saved layout. Changes save normally after that.",
  "common.close": "Close",
  ...
  "settings.notificationsHint": "Choose from 12 new cues, with separate sounds for sessions and chats.",
  "settings.notifications.preview": "Preview",
  "settings.notifications.previewing": "Playing…",
  "settings.notifications.previewUnavailable": "The cue could not be played. Check device volume, audio service, and output device.",
  "settings.notifications.sound.off": "Off",
  "settings.notifications.sound.bloom": "Bloom",
  "settings.notifications.hint.bloom": "Warm, gently opening chord",
  "settings.notifications.sound.drift": "Drift",
  "settings.notifications.hint.drift": "Airy layers and a soft fade",
  "settings.notifications.sound.moon": "Moonlight",
  "settings.notifications.hint.moon": "Low, calm sustained notes",
  "settings.notifications.sound.droplet": "Droplet",
  "settings.notifications.hint.droplet": "Two bright drops",
  "settings.notifications.sound.glass": "Glass bell",
  "settings.notifications.hint.glass": "Clear bell with a light tail",
  "settings.notifications.sound.spark": "Spark",
  "settings.notifications.hint.spark": "Three ascending sparkles",
  "settings.notifications.sound.marimba": "Marimba",
  "settings.notifications.hint.marimba": "Rounded low and high strikes",
  "settings.notifications.sound.pluck": "Pluck",
  "settings.notifications.hint.pluck": "Short, softly resonant strings",
  "settings.notifications.sound.bamboo": "Bamboo",
  "settings.notifications.hint.bamboo": "Three light rhythmic taps",
  "settings.notifications.sound.orbit": "Orbit",
  "settings.notifications.hint.orbit": "Smooth ascending electronic notes",
  "settings.notifications.sound.pulse": "Pulse",
  "settings.notifications.hint.pulse": "Two pulses and a final response",
  "settings.notifications.sound.arcade": "Pixel",
  "settings.notifications.hint.arcade": "A playful four-note retro cue",
  ...
  "settings.notifications.group.bright": "Bright",
  "settings.notifications.group.natural": "Natural",
  "settings.notifications.group.digital": "Electronic",
  ...
  "theme.dusk": "Dusk",
  "theme.dark": "Mist",
  "theme.light": "Mist Blue",
  "theme.system.hint": "Switch between Mist and Mist Blue with your system",
  ...
  "terminal.projects.clearBody": "This disconnects {sessions} local AI CLIs and clears their ordering. Shared folders, conversations, remote connections and login data are kept.",
  ...
  "terminal.projects.cleared": "Local AI workspace items and ordering were removed. Shared folders and conversations were kept.",
  ...
  "terminal.projects.folderDeleteBody": "This folder will be removed from both Chat and Work Sessions. Its contents move up one level; conversations are kept and sessions keep running.",
  "terminal.projects.folderDeleteAction": "Delete folder",
  "terminal.projects.removeProject": "Remove project",
  "terminal.projects.removeProjectTitle": "Remove “{name}”?",
  "terminal.projects.removeProjectBody": "This removes the project from the sidebar list. Your project files and contents on disk will not be deleted.",
  "terminal.projects.removeProjectAction": "Remove project",
  ...
  "agents.mcp.access.off": "Not shared",
  "agents.mcp.access.view": "View only (state and output)",
  "agents.mcp.access.full": "Full (view, send prompts, stop)",
  ...
  "settings.mcpRemote.none": "No connection is open, so an external AI has no remote reach at all. Open one and it appears here.",
  "settings.mcpRemote.pause": "Pause for ten minutes",
  "settings.mcpRemote.hint": "Every connection you open is available to external AI tools: SSH, SFTP, RDP, VNC and Lattice Remote alike, with nothing to set up.",
  "settings.backgroundService.title": "Background service",
  "settings.backgroundService.hint": "The background service keeps detached agents and scheduled chats running after the window closes.",
  "settings.backgroundService.login": "Start at login",
  "settings.backgroundService.loginHint": "When on, the service starts as soon as you log in, so schedules run after a reboot without opening LatticeTerm first. With no schedules or background work it exits within a minute.",
  ...
  "settings.mcpRemote.connectFirst": "Save a connection under My Connections first, then select permissions here.",
  "settings.mcpRemote.connection": "Connected or saved connection",
  "settings.mcpRemote.choose": "Choose a connection",
  "settings.mcpRemote.saved": "Saved",
  "settings.mcpRemote.savedHint": "LatticeTerm uses the saved password, SSH key preference or Lattice Remote pairing code in the native layer; credentials are never given to the AI. After connecting, choose and confirm the operation scopes below.",
  "settings.mcpRemote.connectSaved": "Connect with saved credential",
  ...
  "settings.mcpRemote.scope.command": "Run commands the AI proposes (you approve each one)",
  "settings.mcpRemote.scope.upload": "Upload new files",
  "settings.mcpRemote.scope.download": "Download files",
  "settings.mcpRemote.scope.fleetObserve": "Observe a remote Fleet workspace",
  "settings.mcpRemote.scope.fleetRead": "Read remote Agent output",
  "settings.mcpRemote.scope.fleetControl": "Send prompts and cancel remote Agent tasks",
  "settings.mcpRemote.scope.fleetLaunch": "Start approved remote Agent plans",
  "settings.mcpRemote.fleetTitle": "Remote Fleet workspace over SSH",
  "settings.mcpRemote.fleetHint": "Use an existing trusted SSH connection to a Windows, Linux or macOS host with an updated LatticeTerm. The remote background service must already be running; its sessions and launch plans must be explicitly shared there. Only the approved directory and its subdirectories are available. Agent commands run with the remote account and CLI permissions; this directory filter is not an OS sandbox. Disconnecting or revoking access does not undo accepted work or terminate background Agents.",
  "settings.mcpRemote.fleetPlatform": "Remote operating system",
  "settings.mcpRemote.fleetWindowsHint": "Use full Windows paths with a drive letter. Network shares, device paths and whole drives are not accepted. The SSH account must reach its existing LatticeTerm background service and be allowed to run Windows PowerShell.",
  "settings.mcpRemote.fleetExecutable": "Remote LatticeTerm executable (absolute path)",
  "settings.mcpRemote.fleetDataDirectory": "Remote LatticeTerm data directory (absolute path)",
  "settings.mcpRemote.fleetDirectory": "Approved Agent working directory (absolute path)",
  "settings.mcpRemote.scope.input": "Keyboard and mouse",
  "settings.mcpRemote.inputHint": "Requires screen capture. Input may change files or settings and runs with the remote account privileges. Typing, clicking or moving in the viewer revokes this MCP input grant; grant again to resume.",
  "settings.mcpRemote.scope.screen": "Capture the current screen (one still)",
  "settings.mcpRemote.screenHint": "External AI can capture one image every two seconds from this connection, including other windows, notifications and private content. Screen capture and input require separate scopes. Reconnection ends the grant.",
  ...
  "settings.mcpRemote.commandText": "Command",
  "settings.mcpRemote.timeout": "Timeout in seconds (1-60)",
  "settings.mcpRemote.timeoutValue": "{seconds}s timeout",
  "settings.mcpRemote.addCommand": "Add this command",
  "settings.mcpRemote.removeCommand": "Remove",
  "settings.mcpRemote.commandLimit": "That is the limit of {count} commands; remove one before adding another.",
  ...
  "settings.mcpRemote.level": "Access level",
  "settings.mcpRemote.level.view": "View only",
  "settings.mcpRemote.level.full": "Full access",
  "settings.mcpRemote.level.rdp.view": "Lets the AI take still pictures of this connection's screen.",
  "settings.mcpRemote.level.rdp.full": "Screen plus keyboard and mouse. When you move the mouse or type in the remote window yourself, the AI loses input control until you grant it again.",
  "settings.mcpRemote.level.remote.view": "Screen; if the host shares a Fleet workspace, also the state and output of remote agents.",
  "settings.mcpRemote.level.remote.full": "Screen with keyboard and mouse; if the host shares a Fleet workspace, the AI can also send prompts to, cancel and launch remote agents. Your own input in the remote window takes back keyboard and mouse control.",
  "settings.mcpRemote.level.ssh.view": "Reads this Linux host's CPU, memory and disk information.",
  "settings.mcpRemote.level.ssh.full": "Host information, and the AI may propose commands to run; each one pops up for you to read before it runs.",
  "settings.mcpRemote.level.sftp.view": "Lists and downloads files in the remote folder below into the local folder.",
  "settings.mcpRemote.level.sftp.full": "Lists, downloads and uploads new files in the remote folder below; existing files are never overwritten.",
  "settings.mcpRemote.level.nothing": "This connection shares neither a screen nor a Fleet workspace, so there is nothing to grant.",
  "settings.mcpRemote.grantLevel": "Grant to MCP",
  "settings.mcpRemote.advanced": "Custom details",
  "settings.mcpRemote.level.vnc.view": "Lets the AI take still pictures of this connection's screen.",
  "settings.mcpRemote.level.vnc.full": "Screen plus keyboard and mouse. When you move the mouse or type in the remote window yourself, the AI loses input control until you grant it again.",
  "settings.mcpRemote.commandScopeHint": "The AI writes the command, but every call stops here first: you read the exact text and decide. Nobody answering means refused after two minutes. Commands run with this SSH account's permissions and are not sandboxed.",
  "mcp.commandApproval.title": "An AI wants to run a command",
  "mcp.commandApproval.connection": "Connection",
  "mcp.commandApproval.client": "Requested by",
  "mcp.commandApproval.command": "Command",
  "mcp.commandApproval.warning": "Allowing runs it immediately with this SSH account's permissions. It is not sandboxed and cannot be undone. Refuse anything you cannot read.",
  "mcp.commandApproval.approve": "Allow once",
  "mcp.commandApproval.approveQuiet": "Allow and stop asking for {minutes} min",
  "settings.mcpRemote.quietActive": "Proposed commands run unasked for about {minutes} more min",
  "settings.mcpRemote.quietClear": "Ask me every time again",
  "mcp.commandApproval.deny": "Refuse",
  "mcp.commandApproval.expires": "Refused automatically in {seconds} s",
  "mcp.commandApproval.queued": "{count} more waiting for you",
  "agents.mcp.history.title": "MCP operation history",
  "agents.mcp.history.action.remoteFleet": "Remote Agent Fleet operation",
  "agents.mcp.history.action.remoteInput": "Send remote input",
  ...
  "agents.mcp.history.action.remoteCommand": "Run proposed command",
  ...
  "agents.remoteFleet.eyebrow": "Remote workspace",
  "agents.remoteFleet.title": "Remote Agent Fleet",
  "agents.remoteFleet.body": "See Agent sessions another machine shared, right here: output side by side, queue prompts, cancel a turn or start saved items. It uses the scopes you granted this connection under Settings → Remote MCP; the other machine's output is untrusted data.",
  "agents.remoteFleet.refresh": "Refresh",
  "agents.remoteFleet.none": "No remote connection has a Fleet grant yet. In Settings → Remote MCP, pick an SSH or Lattice Remote connection and enable the Fleet scopes.",
  "agents.remoteFleet.target": "Connection",
  "agents.remoteFleet.offline": "offline",
  "agents.remoteFleet.launch": "Start “{label}”",
  "agents.remoteFleet.noSessions": "This workspace shares no sessions right now.",
  "agents.remoteFleet.show": "Show side by side",
  "agents.remoteFleet.hide": "Hide",
  "agents.remoteFleet.cancel": "Cancel this turn",
  "agents.remoteFleet.waiting": "Waiting for output…",
  "agents.remoteFleet.promptPlaceholder": "Queue a prompt (sent when this turn ends)",
  "agents.remoteFleet.send": "Send",
  "agents.pacing.limit": "Working at once",
  "agents.pacing.unlimited": "No limit",
  "agents.pacing.count": "{count}",
  "agents.pacing.hint": "Past the limit, queued prompts wait; running work is never interrupted.",
  "agents.pacing.waitsFor": "Waits for",
  "agents.pacing.none": "No other agent",
  "agents.pacing.errorTitle": "Could not change the queue",
  ...
  "chat.attachment.paste": "Paste",
  "chat.attachment.pasting": "Adding image…",
  "chat.attachment.pasteHint": "Attach files or an image from the clipboard, or press Ctrl/⌘+V in the message box.",
  "chat.attachment.clipboardEmpty": "No readable files or image are on the clipboard. Copy files in your file manager, or copy an image or take a screenshot first.",
  ...
  "settings.cliProxy.nameHint": "Shown in the pickers. The address is used when this is empty.",
  "settings.cliProxy.empty": "No proxy has been added yet.",
  "settings.cliProxy.limit": "Up to {count} proxies.",
  "settings.cliProxy.boundary": "Start your proxy and sign in to its upstream accounts first. LatticeTerm configures Codex for the connection without writing the key to CLI configuration files.",
  "settings.cliProxy.desktopOnly": "Requires the desktop application.",
  "settings.cliProxy.address": "Proxy address",
  "settings.cliProxy.addressHint": "Only http and https. The port is CLIProxyAPI's own, 8317 by default.",
  "settings.cliProxy.test": "Test and save",
  "settings.cliProxy.clear": "Remove this proxy",
  "settings.cliProxy.reachable": "The address answered as a CLIProxyAPI server.",
  "settings.cliProxy.unreachable": "The address answered with {status}; check that the proxy is running there.",
  "settings.cliProxy.key": "API key",
  "settings.cliProxy.keyHint": "One of the keys in the proxy's api-keys list. The desktop side keeps it, bound to the address above, and never shows it again. Leave it empty if the proxy runs without keys.",
  "settings.cliProxy.keySaved": "A key is saved for this address.",
  "settings.cliProxy.keyMissing": "No key is saved; the proxy is asked without one.",
  "settings.cliProxy.keySave": "Save the key",
  "settings.cliProxy.keyForget": "Delete the key",
  "settings.cliProxy.models": "Models the proxy accepts",
  "settings.cliProxy.modelsLoading": "Asking the proxy…",
  "settings.cliProxy.modelsReady": "{count} models available.",
  "settings.cliProxy.modelsReload": "Ask again",
  "cliproxy.id.invalid": "That proxy identifier is not usable. Add the proxy again.",
  "cliproxy.url.empty": "Enter the proxy address.",
  "cliproxy.url.long": "The proxy address is too long.",
  "cliproxy.url.invalid": "That is not a usable proxy address.",
  "cliproxy.url.scheme": "The address has to start with http:// or https://.",
  "cliproxy.key.empty": "Enter the API key.",
  "cliproxy.key.long": "The API key is too long.",
  "cliproxy.key.invalid": "The API key contains characters that cannot be sent in a request.",
  "cliproxy.key.rebound": "The saved key belongs to a different address. Save it again for this one.",
  "cliproxy.models.unauthorized": "The proxy refused the key. Check the api-keys list in its configuration.",
  "cliproxy.models.unreadable": "The answer was not a model list; check that this address is CLIProxyAPI.",
  "cliproxy.models.oversized": "The answer was too large to be a model list.",
  "cliproxy.models.empty": "The proxy reported no usable models. Sign in to a plan on its management page first.",
  "cliproxy.models.status": "The proxy answered with {status}.",
  "terminal.proxy.choose": "Choose a proxy model",
  "terminal.proxy.manual": "Other — type a model ID",
  "terminal.proxy.unavailable": "The model list could not be read; type a model ID the proxy accepts.",
  ...
  "chat.folder.delete.body": "This folder will be removed from both Chat and Work Sessions. Its contents move up one level; conversations are kept and sessions keep running.",
  ...
  "chat.tool.lines": "{count} lines",
  "chat.tool.results": "{count} results",
  "chat.delegate.noteDone": "Subtask “{title}” finished",
  "chat.delegate.noteFailed": "Subtask “{title}” failed",
  "chat.delegate.noteGone": "(deleted subtask)",
  "chat.delegate.title": "Delegate a subtask",
  "chat.delegate.assistant": "Hand to",
  "chat.delegate.machine": "Run on",
  "chat.delegate.machine.local": "This computer",
  "chat.delegate.plan": "Saved item to start",
  "chat.delegate.plan.hint": "The subtask starts a new agent from that machine's saved item; its folder and CLI come from the item.",
  "chat.delegate.task": "What should it do",
  "chat.delegate.placeholder": "e.g. write an English README in this folder",
  "chat.delegate.withContext": "Include this conversation as reference",
  "chat.delegate.start": "Start",
  "chat.delegate.open": "Open",
  "chat.delegate.bringBack": "Bring back result",
  "chat.delegate.retry": "Retry",
  "chat.delegate.state.running": "Running",
  "chat.delegate.state.done": "Done",
  "chat.delegate.state.failed": "Failed",
  "chat.delegate.state.waiting": "Not started",
  "chat.projects": "Projects",
  "chat.projects.none": "No conversation has a folder yet. Choose a working folder in a conversation's settings and it appears here.",
  "chat.projects.count": "{count} conversations",
  "chat.projects.newChat": "New chat in “{name}”",
  "chat.projects.clear": "Show all conversations",
  "chat.tool.exitCode": "exit {code}",
  "chat.images": "Images mentioned in the reply",
  ...
  "chat.changes.commentPlaceholder": "What should the assistant do here?",
  "chat.changes.addComment": "Add comment",
  "chat.changes.removeComment": "Remove",
  "chat.changes.sendComments": "Put {count} comments in the message",
  ...
  "chat.mcp.disabled": "Off",
  "chat.mcp.secrets": "Uses these secrets (values hidden): {names}",
  "chat.mcp.add": "Add a server:",
  "chat.mcp.copy": "Copy command",
  "chat.mcp.copied": "Copied",
  "chat.changes": "Changes",
  "chat.changes.count": "{count} files",
  "chat.changes.refresh": "Refresh",
  "chat.changes.close": "Close changes",
  "chat.changes.clean": "No changes in the working tree.",
  "chat.changes.staged": "Staged",
  "chat.changes.unstaged": "Not staged",
  "chat.changes.stageAll": "Stage all",
  "chat.changes.stage": "Stage",
  "chat.changes.unstage": "Unstage",
  "chat.changes.messagePlaceholder": "Commit message",
  "chat.changes.commit": "Commit ({count} files)",
  "chat.changes.committed": "Created commit {hash}",
  "chat.changes.waitForTurn": "Wait for this reply to finish before committing",
  "chat.changes.quote": "Quote in message",
  "chat.changes.noDiff": "No difference for this file.",
  "chat.changes.truncated": "The diff is long; showing the first 512 KiB.",
  "chat.changes.pick": "Pick a file to see its diff.",
  "chat.terminal": "Terminal",
  "chat.terminal.restart": "Restart terminal",
  "chat.terminal.close": "Close terminal (ends this shell)",
  "chat.terminal.exited": "Terminal exited (code {code})",
  "chat.terminal.inputFailed": "Could not send input to the terminal",
  "chat.effort": "Reasoning effort",
  "chat.effort.default": "Default (per model)",
  "chat.instructions.title": "Instructions & memory",
  "chat.instructions.hint": "Instruction files this assistant reads on its own before the conversation starts. User-level files can be edited here (a save is refused if the file changed elsewhere); edit the project's shared AGENTS.md below.",
  "chat.instructions.user": "User",
  "chat.instructions.project": "Project",
  "chat.instructions.truncated": "Showing the first 64 KiB of {kib} KiB.",
  "chat.instructions.none": "No instruction files yet.",
  "chat.instructions.missing": "Not created:",
  "chat.instructions.reload": "Reload",
  "chat.instructions.editShared": "Edit shared project rules (AGENTS.md)",
  "chat.shelve": "Archive",
  "chat.unshelve": "Unarchive",
  "chat.shelf.title": "Archived ({count})",
  "chat.branch": "Branch from here",
  "chat.branch.suffix": "(branch)",
  "chat.elicitation.urlHost": "Opens {host} in your browser",
  "chat.elicitation.openUrl": "Open page and continue",
  "chat.elicitation.hint": "These values go straight to the MCP server that asked. Never enter passwords or API keys here.",
  ...
  "remote.host.autoStandby": "LatticeTerm is available while the app is running. Closing this dialog keeps it available; quitting the app takes it offline.",
  "remote.host.title": "Share this device",
  "remote.host.action": "Share this device",
  "remote.host.activeAction": "Sharing active",
  "remote.host.securityTitle": "Pairing and permissions",
  "remote.host.problemTitle": "Sharing status changed",
  "remote.host.relayDnsFailure": "The relay server could not be found. Check the address below and your network and DNS settings. LatticeTerm will retry automatically.",
  ...
  "remote.host.copyCode": "Copy pairing password",
  ...
  "remote.host.fixedCode": "Unattended pairing password (optional)",
  "remote.host.fixedCodePlaceholder": "Leave empty to generate one",
  "remote.host.fixedCodeHint": "6-64 characters: case-sensitive ASCII letters, digits and symbols, without spaces. Mixing character types is recommended, not required. Avoid common passwords. When secure storage is available, an entered password can be stored and reused after restart; leave empty for a random token for this run. Five incomplete attempts in ten minutes pause pairing, even across restarts.",
  "remote.host.savedPasswordTitle": "Unattended password stored securely",
  "remote.host.useSavedPassword": "Use the host password saved in secure storage",
  "remote.host.rememberPassword": "Save to {provider} after startup; reuse it after restart when secure storage is available",
  "remote.host.removeSavedPassword": "Delete saved password",
  "remote.host.cleanupPendingTitle": "Secure cleanup still needs attention",
  "remote.host.cleanupPendingBody": "An older securely stored copy could not be removed while its store was unavailable. This does not change whether the currently selected password is saved. Unlock or restore that store, then retry cleanup.",
  "remote.host.retryCleanup": "Retry secure cleanup",
  "remote.host.loadingSavedPassword": "Checking secure storage for the host password…",
  "remote.host.passwordSavedActive": "The unattended password is stored securely and will be reused after restart when secure storage is available",
  "remote.host.passwordStoredBadge": "Password saved",
  "remote.host.passwordActiveNotStored": "The current password remains active only for this share; it will not be reused after sharing stops or the app restarts",
  "remote.host.savedPasswordMissingTitle": "Saved host password not found",
  "remote.host.savedPasswordMissingBody": "Automatic standby stays fail-closed and will not switch to a random password. Clear the option below before entering and saving a new password.",
  "remote.host.keepUsingSavedPassword": "Still require the saved host password (stop startup if unavailable)",
  ...
  "remote.host.codePersistent": "Pairing code remains valid for this app session",
  ...
  "remote.cli.shareHint": "Paired viewers can read and control existing desktop and background CLIs. Input goes to the original process with its host account and permissions.",
  "remote.cli.loading": "Loading CLI sessions…",
  "remote.cli.title": "CLI sessions",
  ...
  "remote.cli.background": "Background session",
  "remote.cli.desktop": "Desktop session",
  "remote.cli.ready": "Connected to the existing CLI. Ready for input.",
  "remote.cli.truncated": "Earlier output is outside the host retention window. Showing the available terminal output.",
  "remote.chat.allow": "Share and control conversations",
  "remote.chat.shareHint": "Paired viewers can read desktop conversations, send messages, create conversations with existing settings, stop turns and answer approvals. Each conversation retains its account and permissions. Keep the host window open.",
  "remote.chat.title": "Sessions and conversations",
  "remote.chat.sessions": "Sessions",
  "remote.chat.refresh": "Refresh",
  "remote.chat.hint": "Choose a host conversation to view progress and continue it.",
  "remote.chat.empty": "No conversations on this host. Create a conversation on the host first.",
  ...
  "remote.chat.latest": "Latest messages",
  "remote.chat.truncated": "Open the host to review the full content.",
  "remote.chat.approve": "Allow this operation",
  "remote.chat.deny": "Deny",
  "remote.chat.message": "Message",
  "remote.chat.stop": "Stop turn",
  "remote.chat.send": "Send",
  "remote.chat.loading": "Loading host conversation…",
  "remote.chat.item.user": "You",
  "remote.chat.item.text": "Agent",
  "remote.chat.item.reasoning": "Reasoning",
  "remote.chat.item.tool": "Tool",
  "remote.chat.item.notice": "Notice",
  "remote.chat.item.approval": "Approval",
  "remote.chat.item.turnEnd": "Turn ended",
  "remote.commands.title": "Commands",
  "remote.commands.hint": "Run one command at a time. Directory and environment changes do not persist between runs. Use a terminal for interactive input.",
  "remote.commands.allow": "Allow cmd / PowerShell commands",
  "remote.commands.allowHint": "The viewer can run programs and access files as your Windows account, beyond the shared folder. Revoking command access or quitting the app ends running commands.",
  "remote.commands.shell": "Shell",
  "remote.commands.directory": "Working directory",
  "remote.commands.home": "Host user home folder when empty",
  "remote.commands.command": "Command",
  "remote.commands.timeout": "Time limit",
  "remote.commands.seconds": "seconds",
  "remote.commands.run": "Run",
  "remote.commands.stop": "Stop",
  "remote.commands.tooLarge": "Commands are limited to 16 KiB.",
  "remote.commands.result": "Result",
  "remote.commands.exitCode": "Exit code",
  "remote.commands.stdout": "Standard output",
  "remote.commands.stderr": "Error output",
  "remote.commands.state.starting": "Starting",
  "remote.commands.state.running": "Running",
  "remote.commands.state.cancelling": "Stopping",
  "remote.commands.state.exited": "Exited",
  "remote.commands.state.cancelled": "Stopped",
  "remote.commands.state.timedOut": "Time limit reached",
  "remote.commands.state.outputLimit": "Stopped at the 512 KiB output limit",
  "remote.commands.state.failed": "Failed",
};
