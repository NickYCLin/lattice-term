...
export const en: Messages = {
  ...
  "agents.mcp.hint": "LatticeTerm can act as an MCP server so another AI tool (Claude Code, Codex, Gemini CLI, …) gets a read-only view of the background sessions you choose to share: list their state, read terminal output, wait for a state change. Only sessions kept in the background and ticked \"Share with MCP\" below are visible; nothing can be launched, prompted or stopped. Add one of the snippets below to your AI tool to connect.",
