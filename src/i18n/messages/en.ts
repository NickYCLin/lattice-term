...
export const en: Messages = {
  ...
  "jev.setup.login": "Open the official TypeSafe console and sign in with Google or email. If your account shows a waitlist or access request, follow its instructions.",
