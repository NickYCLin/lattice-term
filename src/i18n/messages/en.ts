...
export const en: Messages = {
  ...
  "terminal.proxy.hint": "Set the cliproxyapi provider up in this Codex account's own configuration first. The list comes from the proxy set in Settings; LatticeTerm does not write the key into the CLI's configuration.",
  "settings.cliProxy.title": "CLIProxyAPI",
  "settings.cliProxy.hint": "Point LatticeTerm at the CLIProxyAPI server you run, so the Fleet launcher can offer the models it actually accepts.",
  "settings.cliProxy.boundary": "LatticeTerm reads only the address and the model list. Starting the proxy, signing in to the plans, and writing the cliproxyapi section into each CLI's own configuration all stay with you.",
  ...
  "settings.cliProxy.clear": "Remove the address",
