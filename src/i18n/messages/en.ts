...
export const en: Messages = {
  ...
  "cliUpdates.hint": "This window only checks versions; it does not install updates. “Open official update guide” opens the official website in your browser. Save your work and update using your original installation method, then click “Check versions again”. Restart existing CLI sessions to use the new version.",
