...
export const en: Messages = {
  ...
  "agents.mcp.history.hint": "Keeps the latest 256 write requests for this background service, refreshed every 10 seconds. Survives closing the window, but clears when the service ends. No prompts, credentials or raw errors are saved. Client names are self-reported, not verified identities; accepted does not mean the task completed.",
  "agents.mcp.history.unavailable": "History is unavailable. The background service may be stopped or not support history yet.",
  "agents.mcp.history.empty": "No MCP write requests in this background service yet.",
