...
export const en: Messages = {
  ...
  "remote.commands.allowHint": "The viewer can run programs and access files as your Windows account, beyond the shared folder. Stopping sharing ends running commands.",
