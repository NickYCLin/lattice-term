...
import { BackgroundServicePanel } from "../components/settings/BackgroundServicePanel";
...
export function SettingsView({
  ...
  return (
    <div className="stack">
      ...
      {!usesAppleUpdates && <BackgroundServicePanel available={desktopBackendAvailable} />}
