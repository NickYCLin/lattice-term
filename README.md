...
<table>
  ...
  <tr>
    ...
    <td width="50%" valign="top">
      <h3>排程與背景工作</h3>
      <p>為固定任務設定排程，回來查看執行結果。Agent 工作階段可選擇留在本機背景服務，關閉視窗後繼續執行，下次開啟再接回；也能另外授權支援 MCP 的外部 AI 工具查看、在 CLI 確認就緒後下指示，或啟動已保存的項目。撤權會清除尚未派送的 MCP 指示；介面可查看本次背景服務最近 256 筆寫入紀錄。</p>
    </td>
  </tr>
</table>
