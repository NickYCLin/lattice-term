    ...
    async fn get_capabilities(&self) -> Result<Value, ToolError> {
        ...
        Ok(json!({
            ...
            "limitations": [
                ...
                "ssh_run_command is the only way to run text this client wrote. It needs its own grant, and every single call waits for the user to read the command and accept it in LatticeTerm; refusal, silence for two minutes, revocation or a closed desktop all mean it never ran.",
